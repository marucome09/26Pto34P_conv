...
・コネクタの直上までFDDのフレームや、金属カバーが伸びてきているタイプの場合、変換コネクタの金属部分が当たってショートする恐れがあります。（写真のような場合）この場合は、当たる面、つまり26ピンコネクタの裏側を絶縁テープなどを使って絶縁してください。固定を兼ねて厚手の両面テープを全面に貼るのもいいと思います。
